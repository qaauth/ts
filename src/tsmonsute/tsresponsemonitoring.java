...
public class tsresponsemonitoring {
	//private static final String FILENAME = "C:\Users\shariq.abbas.ABRSPL/Desktop/Crucial/filename.txt";
	private static final String FILENAME = "/home/shariq.abbas/tsbrstchk/filenameres.txt";
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
		...
		File fl=new File("/home/shariq.abbas/tsbrstchk/reportres.html");int i=300;
		while(i>0) {
			i=i-1;
	...
	public static void maintwo() throws IOException, InterruptedException {
		...
		FileInputStream fstream = new FileInputStream("/home/shariq.abbas/tsbrstchk/filenameres.txt");
	...
	// List<String> zoom1 = new ArrayList<>();
		...
		File testfile=new File("/home/shariq.abbas/tsbrstchk/filenameres.txt");
    	...
    	dri.get("file:////home/shariq.abbas/tsbrstchk/reportres.html");
    		...
    		if(d==false) {
     		...
     		try {
    			...
    			bw.newLine();
                    ...
                    bw.write(" , ");
        			bw.write(lstone.get(9).getText());
        			bw.write(":");
        			bw.write(lstone.get(10).getText());
        			bw.newLine();
     			//}
    			//new code
	...
	public static void mailsend(StringBuilder stringBuilder) throws InterruptedException, IOException, ClassNotFoundException {
	  ...
	  // message.setSubject("TruthScreen Services Critical Requests Monitoring Suite for Desktop & WebServices Completed || "
	   ...
	   message.setSubject("TruthScreen Critical Services Request Response Time Monitoring Suite Completed || "
	     		+ "Problem Detected :Autosender Enabled");
	    /* message.setSubject("TruthScreen Services Hourly Monitoring Suite for Desktop & WebServices Completed || "
	     ...
	     message.setText(stringBuilder.toString());
			...
			FileDataSource fds = new FileDataSource("/home/shariq.abbas/tsbrstchk/reportres.html");
